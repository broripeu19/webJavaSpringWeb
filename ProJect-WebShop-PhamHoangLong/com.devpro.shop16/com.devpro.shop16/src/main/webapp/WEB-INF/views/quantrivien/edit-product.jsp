      ...
      <div class="container h-100">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto h-100">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="products-admin">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link d-block" href="login-admin">
                Admin, <b>Logout</b>
              </a>
            </li>
          </ul>
            ...
            <div class="row tm-edit-product-row">
              ...
              <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                <div class="tm-product-img-edit mx-auto">
                  <img src="../imgs/product-image.jpg" alt="Product image" class="img-fluid d-block mx-auto">
                  <i
