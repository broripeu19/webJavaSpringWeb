...
<body id="reportsPage">
				...
				<ul class="navbar-nav mx-auto h-100">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<a class="dropdown-item" href="${base}/admin/users-admin">User</a> 
						</div>
					</li>
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="nav-link" href="${base }/admin/products-admin">Products</a> 
							<a class="nav-link active" href="${base}/admin/saleorders-admin">Sale Order</a>
						</div>
			...
			<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 tm-block-col">
				<div
					...
					<form class="form-inline" action="${base }/admin/saleorders-admin" method="get">
						...
						<table class="table table-striped">
							<thead>
								<tr>
									...
									<th scope="col" class="width-th-col">Status</th>
									<th scope="col">Action</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${saleordersWithPaging.data}" var="saleorders"
									varStatus="loop">
									<tr>
										<th scope="row">${loop.index + 1}</th>
										<td>${saleorders.code }</td>
										<td>${saleorders.customerAddress }</td>
										<td>${saleorders.customerPhone }</td>
										<td>${saleorders.customerEmail }</td>
										<td>Chờ Xác Nhận</td>
										...
										<td>
											...
											<a href="${base }/admin/saleorders-admin/status/${saleorders.id}"  class="btn btn-danger" role="button"
												onclick="XACNHAN(${saleorders.id})">Xác Nhận</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
						...
						<!-- Paging -->
						<div class="row simplePagination-page set-mg">
							<div class="col-12 d-flex justify-content-center margin-top-165px">
								<div id="paging"></div>
							</div>
						</div>
				</div>
	...
	<script>
      ...
      function XACNHAN(productId){
  		if(confirm('Thao tác sau đây sẽ xác nhận sản phẩm!!')){
  			alert("Đã xác sản phẩm thành công!!")
  		}
  	} 
