		...
		<div class="row header-row">
			<nav class="nav font-size-nav shopee-header-top col">
				<a class="nav-link shopee-header-top-hover " href="#">Kênh người
					bán</a> 
					<a class="nav-link shopee-header-top-hover " href="#">
						Subscribe now
					</a> 
					<a class="nav-link appliacation-qr shopee-header-top-hover" href="#">Tải
					ứng dụng
					<div class="qrcode-app">
						<img src="${base}/imgs/QRcode-application-shopee.png"
							class="qrcode-app-img" alt="">
						<div class="d-flex">
							<img src="${base}/imgs/ch_play.png" class="qrcode-app-sub-img"
								alt=""> <img src="${base}/imgs/apstore.png"
								class="qrcode-app-sub-img" alt="">
						</div>
					</div>
		...
		<div class="row">
			...
			<div class="col col-8 shopee-header-content-search">
				<form class="d-flex form-search">
					...
					<select
							class="form-control select-category search-categories" name="categoryId"
...
<%--				<div
					...
					<div class="d-flex flex-row justify-content-between mt-4">
						<div class="d-flex flex-row">
							...
							<input type="text" id="keyword" name="keyword"
								class="form-control keyword-search-product" placeholder="Tìm kiểm sản phẩm"
							...
							<button type="submit" id="btnSearch" name="btnSearch"
								value="Search" class="btn btn-primary btn-primary-search">Tìm kiếm</button>
						</div>
				...
				<ul class="nav shopee-nav-search">
					<li class="nav-item"><a class="nav-link text-light" href="#">Đầm</a></li>
					...
					<li class="nav-item"><a class="nav-link text-light" href="#">Áo
							phông</a></li>
					<li class="nav-item"><a class="nav-link text-light" href="#">Chân váy</a></li>
					<li class="nav-item"><a class="nav-link text-light" href="#">Áo
							croptop</a></li>
					<li class="nav-item"><a class="nav-link text-light" href="#">Túi</a></li>
					<li class="nav-item"><a class="nav-link text-light" href="#">Áo dài</a></li>
					<li class="nav-item"><a class="nav-link text-light" href="#">Áo len</a></li>
				</ul>
			</div>
			<div class="col col-1 shopee-header-content-cart">
				<div>
	               <a href="${base}/cart/view" class="cart-a-css">
	               	<span id="iconShowTotalItemsInCart" class="badge cartItem-css ms-1 rounded-pill">
							${totalItems }
					</span>
	                <svg xmlns="http://www.w3.org/2000/svg" width="30"  fill="currentColor" class="bi bi-cart text-light shopee-header-cart" viewBox="0 0 16 16">
			...
			<div class="col col-1 header-button-phone">
				...
				<div class="offcanvas offcanvas-start" tabindex="-1"
					...
					<div class="offcanvas-header offcanvas-header-shopee-mobile">
						<h2 class="offcanvas-title" id="offcanvasExampleLabel">Shopee</h2>
