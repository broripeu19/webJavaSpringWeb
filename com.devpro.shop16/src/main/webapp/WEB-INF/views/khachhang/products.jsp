				...
				<div class="product-details">
					...
					<div class="product-details-rate">
						...
						<div class="product-details-rating-evaluate evaluate-1">
							<div class="count-evaluate-rating">${Math.floor(Math.random() * 100)}</div>
							<div class="count-evaluate-rating-text">Đánh Giá</div>
						</div>
						<div class="product-details-rating-evaluate">
							<div class="count-evaluate-rating">${Math.floor(Math.random() * 500)}</div>
							<div class="count-evaluate-rating-text">Đã Bán</div>
						</div>
						<div class="product-details-rating-evaluate">
							<button class="product-variation" onclick="javascript:AddToCompare('${base }', ${product.id}, 1);">
								<svg xmlns="http://www.w3.org/2000/svg" width="22" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#0a68ff" d="M320 488c0 9.5-5.6 18.1-14.2 21.9s-18.8 2.3-25.8-4.1l-80-72c-5.1-4.6-7.9-11-7.9-17.8s2.9-13.3 7.9-17.8l80-72c7-6.3 17.2-7.9 25.8-4.1s14.2 12.4 14.2 21.9v40h16c35.3 0 64-28.7 64-64V153.3C371.7 141 352 112.8 352 80c0-44.2 35.8-80 80-80s80 35.8 80 80c0 32.8-19.7 61-48 73.3V320c0 70.7-57.3 128-128 128H320v40zM456 80a24 24 0 1 0 -48 0 24 24 0 1 0 48 0zM192 24c0-9.5 5.6-18.1 14.2-21.9s18.8-2.3 25.8 4.1l80 72c5.1 4.6 7.9 11 7.9 17.8s-2.9 13.3-7.9 17.8l-80 72c-7 6.3-17.2 7.9-25.8 4.1s-14.2-12.4-14.2-21.9V128H176c-35.3 0-64 28.7-64 64V358.7c28.3 12.3 48 40.5 48 73.3c0 44.2-35.8 80-80 80s-80-35.8-80-80c0-32.8 19.7-61 48-73.3V192c0-70.7 57.3-128 128-128h16V24zM56 432a24 24 0 1 0 48 0 24 24 0 1 0 -48 0z"/></svg>
								So sánh sản phẩm</button>
						</div>
					</div>
