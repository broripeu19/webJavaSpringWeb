	...
	<div class="" id="home">
		...
		<div class="container h-100">
			<a class="navbar-brand" href="${base }/admin/index">
				<h1 class="tm-site-title mb-0">XMATE 95 Admin</h1>
			</a>
				...
				<ul class="navbar-nav mx-auto h-100">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item active" href="${base }/admin/categories-admin">Category</a>
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="nav-link active" href="${base }/admin/accounts">Accounts</a>
