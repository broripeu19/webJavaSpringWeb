							...
							<a href="${base }/products/${product.seo}"
								...
								<div class="section-recommend-products-wrappe-content-title">
									<div class="section-recommend-products-wrappe-content">
										...
										<div class="shopee-item-card__hover-footer">Xem chi tiết sản phẩm</div>
									</div>
								</div>
								<div class="section-hot-sale-product-sale">
									<div class="section-shopee-badge">
										<div class="section-shopee-badge-sub">
											<span class="section-shopee-badge-sub-percent">Đang</span> <span>Sale</span>
										</div>
									</div>
								</div>
							</a>
	...
	<script type="text/javascript">
		...
		$( document).ready(function() {
			...
			document.addEventListener('DOMContentLoaded', function() {
				...
				var count = 0; // Biến đếm số lần next đã được thực hiện
				...
				myCarousel.addEventListener('slide.bs.carousel', function (e) {
					...
					if (e.direction === 'next' && activeSlideIndex === slides.length - 1) {
						count++;
						if (count === 4) { // Quay trở lại slide đầu tiên sau khi next 4 lần
							carousel.to(0); // Quay về slide đầu tiên
							count = 0; // Đặt lại biến đếm
						} else {
							carousel.pause();
						}
					} else if (e.direction === 'prev' && activeSlideIndex === 0) {
						carousel.pause();
					}
				});
			});
