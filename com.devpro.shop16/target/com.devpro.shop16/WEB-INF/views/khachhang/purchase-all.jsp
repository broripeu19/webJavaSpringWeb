			...
			<div class="container _1QwuCJ">
						...
						<div class="stardust-dropdown">
							<div class="stardust-dropdown__item-header">
								<a class="_3aAm2h" href="/user/coin"><div
									...
									<div class="_2i7380">
										<span class="_3CHLlN">XMATE Xu</span>
									</div></a>
							</div>
							<div class="stardust-dropdown__item-body">
								<div class="_3aiYwk"></div>
				...
				<div class="_3D9BVC">
					<div class="_2mSi0S">
						<div></div>
						<div class="ZS1kj6">
							<a class="_2sowby _2sowby-bd _23VQQX" href="/user/purchase/?type=6">
								<span class="_2pSH8O">Tất cả</span>
							</a>
							<a class="_2sowby" href="${base}/purchase-history">
					...
					<c:forEach items="${saleorderProductWithPaging.data}" var="saleorderpd" varStatus="loop">
						<c:if test="${isLogined && saleorderpd.user.id == userLogined.id }"> 
							<div class="_2n4gHk">
								<div>
									<div class="GuWdvd">
										<div class="WqnWb-">
													...
													<a class="_3nBhmP"
														href="${base }/products/${product.seo}"><svg
															...
															class="shopee-svg-icon icon-free-shipping-line">
								                              ...
								                              <c:if test="${saleorderpd.status == true}">
																<span class="_36mfQM_Status"> Chờ xác nhận </span>
															  </c:if>
															  <c:if test="${saleorderpd.status == false}">
																<span class="_36mfQM"> Đã xác nhận</span>
															  </c:if>
								                    </a>
															...
															<div class="_3huAcN">
																...
																<div class="_1cxKtp">
																	...
																	<div class="price-quality">
																		...
																		<div class="_2H6lAy">Giá : ${saleorderpd.product.price} ₫</div>
																	</div>
																</div>
															</div>
															<div class="_1kvNGb">
								...
								<div class="_37UAJO">
									<div class="_1CH8fe">
										...
										<div class="_1MS3t2">₫ ${saleorderpd.product.price * saleorderpd.quality}</div>
									</div>
								</div>
								<div class="_1Qn42s">
									<div class="_1lM63-">
